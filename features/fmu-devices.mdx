...
<Frame caption="FMU device management in the admin panel">
  <img src="/images/admin-company-fmus.png" alt="FMU devices list showing status, title, location, and device ID columns" />
</Frame>
